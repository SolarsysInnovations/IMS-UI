...
const InvoiceList = () => {
    ...
    const [getInvoiceListScreen, { data: invoiceList, error: errorInvoiceList }] = useGetInvoiceListScreenMutation();
    ...
    const handleApplyFilter = useCallback(async () => {
        ...
        }, [startDate, endDate, getInvoiceListScreen]);
      
        // useEffect(() => {
        //     if (startDate && endDate) {
        //       handleApplyFilter();
        //     }
        //   }, [startDate, endDate, handleApplyFilter]);
    ...
    return (
        <Box px={0} py={2}>
            <TableHeader headerName="Invoices" buttons={buttons} />
            <Box mb={3}>
                <Formik
                    initialValues={{
                        startDate: startDate,
            ...
            {errorInvoiceList ? (
                <Typography variant="caption" color="error">*Please apply the filters to display the invoices* {errorInvoiceList.message}</Typography>
            ) : (
                <GridDataUi
                    showToolbar
                    columns={columns}
