                    ...
                    <View style={{ flexDirection: "row", justifyContent: 'space-between', marginTop: "15px" }}>
                        ...
                        <View>
                            <View style={{ flexDirection: "row", gap: "30px", justifyContent: 'space-between' }}>
                                <View> <Text style={[styles.tableCell, { fontSize: "14px" }]}>Sub Total</Text></View>
                                <View> <Text style={styles.tableCell}>{invoiceData.subTotal}</Text></View>
                            </View>
                            <View style={{ flexDirection: "row", gap: "30px", justifyContent: 'space-between', marginTop: "30px" }}>
                                <View> <Text style={[styles.tableCell, { fontSize: "14px" }]}>Discount Percentage {`( ${invoiceData.discountPercentage} % )`}</Text></View>
                                <View> <Text style={styles.tableCell}>{invoiceData.discountPercentageValue}</Text></View>
                            </View>
                            <View style={{ flexDirection: "row", gap: "30px", justifyContent: 'space-between', marginTop: "30px" }}>
                                <View> <Text style={[styles.tableCell, { fontSize: "14px" }]}>Gst Percentage {`( ${invoiceData.discountPercentage} % )`}</Text></View>
                                <View> <Text style={styles.tableCell}>{invoiceData.gstPercentageValue}</Text></View>
                            </View>
                            <View style={{ flexDirection: "row", gap: "30px", justifyContent: 'space-between', marginTop: "30px" }}>
                                <View> <Text style={[styles.tableCell, { fontSize: "14px" }]}>Tds Tax {`( ${invoiceData.taxAmount.tds} )`}</Text></View>
                                <View> <Text style={styles.tableCell}>{invoiceData.tdsAmountValue}</Text></View>
                            </View>
                            <View style={{ flexDirection: "row", gap: "30px", justifyContent: 'space-between', marginTop: "30px" }}>
                                <View> <Text style={[styles.tableCell, { fontSize: "16px" }]}>Total Amount</Text></View>
                                <View> <Text style={styles.tableCell}>{invoiceData.totalValue}</Text></View>
                            </View>
                        </View>
                    </View>
                    <View style={{ borderTop: "1px solid #000", marginTop: "20px" }}></View>
