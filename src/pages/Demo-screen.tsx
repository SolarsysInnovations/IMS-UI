        ...
        >
          <Box gap={3}>
            <Typography variant="subtitle2" color="initial">
              Billed To : <span>Really Great Company</span>
            </Typography>
            <Typography variant="subtitle2" color="initial">
          ...
          <Box gap={3}>
            <Typography variant="subtitle2" color="initial">
              Invoice : <span>INV - 00090</span>
            </Typography>
            <Typography variant="subtitle2" color="initial">
              Invoice Date : <span>09-4-2024</span>
            </Typography>
            <Typography variant="subtitle2" color="initial">
              Terms : <span>Due On Receipt</span>
            </Typography>
            <Typography variant="subtitle2" color="initial">
              Due Date : <span>19-may 2023</span>
            </Typography>
          </Box>
        </Stack>
      </Box>
