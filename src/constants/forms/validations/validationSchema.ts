...
export const invoiceValidationSchema = Yup.object({
  invoiceType: Yup.string().max(255).required("invoiceType is required"),
  invoiceNumber: Yup.string().max(255).required("type is required"),
  customerName: Yup.string().max(255).required("companyName is required"),
  gstType: Yup.string().max(255).required("customerEmail is required"),
  ...
  invoiceDate: Yup.string().max(255).required("paymentTerms is required"),
  gstInNumber: Yup.string().max(255).required("country is required"),
  discountAmount: Yup.string().max(255).required("country is required"),
  paymentTerms: Yup.string().max(255).required("address is required"),
  dueDate: Yup.string().max(255).required("city is required"),
...
export const serviceValidationSchema = Yup.object().shape({
  serviceAccountingCode: Yup.string().required(
    "Service Accounting Code is required"
  ),
