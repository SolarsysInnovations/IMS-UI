  ...
  },
  {
    ...
    subFields: [
      ...
      },
      {
        ...
        type: "selectCity",
        gridSize: 5,
        validation: Yup.string().required("Company City is required"),
        width: "",
      },
      {
        name: "companyAddress",
...
export const linkFields: FieldProps[] = [
  {
    ...
    subFields: [
      ...
      },
      {
        ...
        type: "text",
        gridSize: 5,
        validation: Yup.string().url("Invalid URL").required("URL is required"),
        width: "",
      },
      {
        name: "description",
    ...
    subFields: [
      {
        ...
        type: "text",
        gridSize: 3,
        validation: Yup.string().required("taxName is required"),
        width: "",
      },
      {
        name: "taxPercentage",
        ...
        type: "number",
        gridSize: 2,
        validation: Yup.string().required("taxPercentage is required"),
        endAdornment: "%",
        width: "",
      },
    ],
    ...
    subFields: [
      {
        ...
        type: "text",
        gridSize: 4,
        validation: Yup.string().required("termName is required"),
        helperText: " Eg : Net 30 as 30 days",
        width: "",
      },
      {
        name: "totalDays",
...
export const RolesFields: FieldProps[] = [
  {
    ...
    subFields: [
      ...
      },
      {
        ...
        type: "email",
        gridSize: 6,
        validation: Yup.string().required("userEmail is required"),
        width: "",
      },
      {
        name: "password",
      ...
      },
      {
        ...
        validation: Yup.string()
          ...
          .min(10, "Too short")
          .max(15, "Too long")
          .required("userMobile is required"),
        width: "",
      },
      {
        name: "description",
...
export const RolesEditFields: FieldProps[] = [
  {
    ...
    subFields: [
      ...
      },
      {
        ...
        type: "number",
        gridSize: 6,
        validation: Yup.string().required("number is required"),
        width: "",
      },
      {
        name: "description",
