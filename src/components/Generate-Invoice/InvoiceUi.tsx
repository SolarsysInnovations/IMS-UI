  ...
  useEffect(() => {
    if (invoiceData) {
      ...
      const customerDetails = customers?.find(
        (customer: any) => details === customer.customerName
      );
    ...
    <>
      <div className="App" id="invoiceCapture" style={{ padding: "10px" }}>
        <Grid container spacing={2}>
          ...
          <Grid
            sx={{ borderBottom: "1px solid #dadada", paddingBottom: "20px" }}
            item
            xs={6}
          >
            <Box gap={3}>
              <div>
                <p style={{ fontSize: "12px", margin: "0 0 5px 0" }}>
                  <span style={{ fontWeight: "500" }}>Billed To :</span>{" "}
        ...
        <>
          ...
          >
            ...
            <Box gap={3}>
              ...
              <Typography variant="subtitle2" color="initial">
                TDS Tax : <span>{tds}</span>
              </Typography>
              <Typography variant="h6" color="initial">
                Total : <span>{invoiceData?.invoiceTotalAmount}</span>
              </Typography>
            </Box>
          </Stack>
        </>
